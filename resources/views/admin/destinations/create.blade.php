<x-admin-layout>
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tạo Điểm Đến Mới</h1>
                <p class="mt-1 text-sm text-gray-600">Thêm một điểm đến du lịch mới vào hệ thống</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data" id="destinationForm">
                @csrf
