<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-2xl font-bold text-gray-800">Chỉnh Sửa Email Template</h2>
    ...
    <div class="max-w-4xl">
        <form method="POST" action="{{ route('admin.email-templates.update', $emailTemplate) }}" class="bg-white rounded-lg shadow p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug', $emailTemplate->slug) }}" required
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
                ...
                <textarea name="body" rows="12" required
                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('body', $emailTemplate->body) }}</textarea>
            ...
            <div>
                ...
                <textarea name="variables" rows="3"
                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('variables', json_encode($emailTemplate->variables ?? [])) }}</textarea>
